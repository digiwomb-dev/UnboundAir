...
Prüfe den aktuellen Stand gegen `AGENTS.md` und `docs/plan.md`:

1. **Tests:** Laufen alle Tests im Dev Container grün? Führe sie dort aus (dafür brauchst du eine Freigabe) und nenne das Ergebnis.
2. **Leitplanken:**
...
4. **Plan:**
   - Meilenstein-Status und abgehakte Aufgaben in `docs/plan.md` passen zum tatsächlichen Stand.
