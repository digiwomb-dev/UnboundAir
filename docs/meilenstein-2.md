...
| Was | Stand |
|---|---|
| Zuletzt getesteter Commit | `1c57ce2` (Basislauf) |
| Ergebnis | Basislauf bestanden – frisch angelegter Dev Container (`unboundair-devcontainer --fresh`), Temurin 26.0.2 und libjpeg-turbo 2.1.5 antworten, `./gradlew clean build` grün, 12 Tests ohne Fehler, Linter sauber |
| Als Nächstes zu prüfen | Testpunkt 1, nach dem Bau der Aufgaben T2.6–T2.15 |
...
| 1 | Testbilder als Ressourcen; Maße und iMCU werden aus der Datei gelesen; Papier-Bbox an echten und synthetischen Bildern | T2.6–T2.15 | TE-02, SV-01, SV-02 | *offen* |
